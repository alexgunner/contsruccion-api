...
class SubcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post subcategories_url, params: { subcategory: { category_id: @subcategory.category_id, subcategory_description: @subcategory.subcategory_description, subcategory_name: @subcategory.subcategory_name } }, as: :json
    end
  ...
  test "should update subcategory" do
    patch subcategory_url(@subcategory), params: { subcategory: { category_id: @subcategory.category_id, subcategory_description: @subcategory.subcategory_description, subcategory_name: @subcategory.subcategory_name } }, as: :json
    assert_response 200
  end
