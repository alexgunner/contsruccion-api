class ManufacturersController < ApplicationController
  ...
  private
    ...
    def manufacturer_params
      params.require(:manufacturer).permit(:manufacturer_name, :manufacturer_description, :manufacturer_country, :manufacturer_city, :manufacturer_email, :manufacturer_phone)
    end
end
